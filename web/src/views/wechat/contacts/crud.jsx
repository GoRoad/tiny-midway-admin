 ...
 * 接口配置
 */
const API_PREFIX = '/wechat/contacts'
    ...
    crudOptions: {
      ...
      columns: {
        ...
        id: {
          ...
          form: {
            rule: [{ required: true, message: "请输入微信id", trigger: "blur" }],
            col: { span: 14 },
          },
          column: {
            width: 180,
        ...
        smallHeadImgUrl: {
          ...
          column: {
            render(context) {
              ...
              return (
                <div>
                  <n-image width="55" height="55" object-fit="scale-down" src={context.row.smallHeadImgUrl} >
                  </n-image>
                </div>
              );
            },
